...
- **A compliance toggle.** While researching, I found that routing customers by star rating ("review gating") is against Google's policy and is named as a concern under RIBO Guidance 006 for Ontario brokers. I documented the risk for the client and built a one-word setting that switches the page to an ask-everyone flow.
