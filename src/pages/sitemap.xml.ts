...
// Hand-written: the home page, the case studies in site order and the three utility pages. A
// project another page covers is listed through that page. The 404 page, the endpoints and the
// text files stay out.
